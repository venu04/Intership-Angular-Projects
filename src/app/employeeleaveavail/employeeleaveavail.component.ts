...
@Component({
  selector: 'app-employeeleaveavail',
  templateUrl: './employeeleaveavail.component.html',
  styleUrls: ['./employeeleaveavail.component.css']
})
export class EmployeeleaveavailComponent implements OnInit {
...
getInquiryData() {
  ...
  this.http.post(url, postData1).subscribe(data => {
      ...
      this.inquirydat = this.products_inq.IT_LEAVEBAL.item;
