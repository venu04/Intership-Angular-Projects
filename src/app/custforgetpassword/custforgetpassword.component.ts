...
@Component({
  selector: 'app-custforgetpassword',
  templateUrl: './custforgetpassword.component.html',
  styleUrls: ['./custforgetpassword.component.css']
})
export class CustforgetpasswordComponent implements OnInit {
  httpClient:any;   
  public output=[];
...
forgetpassword(){
  this.router.navigateByUrl('/custforgetpassword');
}
